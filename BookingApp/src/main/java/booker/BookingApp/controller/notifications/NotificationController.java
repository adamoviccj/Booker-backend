...
//    UserService userService;
    ...
    public ResponseEntity<ArrayList<NotificationDTO>> findAllPersonal(@PathVariable String userId){
    ...
    public ResponseEntity<Void> changeSettings(@PathVariable("userId") String userId,
...
//        }
    ...
    public ResponseEntity<NotificationDTO> findNewPersonal(@PathVariable String userId) throws ParseException {
