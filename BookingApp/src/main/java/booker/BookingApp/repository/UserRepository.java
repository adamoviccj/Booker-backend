...
//    @Query(value = "SELECT count(r) from ReservationRequest r WHERE r.createdBy = :guestId AND r.deleted=true")
//    public int getNumOfCancellations(@Param("guestId") String guestId);
