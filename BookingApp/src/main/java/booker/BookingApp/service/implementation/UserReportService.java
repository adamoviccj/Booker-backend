...
//    private UserRepository userRepository;
    ...
    public UserReportDTO create(CreateReportUserDTO createReportUserDTO) {
        ...
        userReport.setCreatedBy(createReportUserDTO.getReporterId());
//        User reporter = userRepository.findByUserId(createReportUserDTO.getReporterId()).get();
//
//
...
//        }
//
//        User reportedUser = userRepository.findByUserId(createReportUserDTO.getReportedId()).orElseGet(null);
...
//        }
    ...
    @Override
    public List<UserReport> getAllForUser(String userId) {
        return userReportRepository.getAllForUser(userId);
    }

    @Override
    public void blockOrUnblock(String userId, boolean blocked) {
