...
-- VALUES ('Marko', 'Marković', 'email1@gmail.com', '$2a$12$Mn1xmYaoG3YjZ1NsPRwV0eDw5wwGbmkhBSooynq8gldJluzqybXP.', 'adresa1', '060000000', 'GUEST', true, false, false, ARRAY[1, 12, 8], 'activation_link1', true, false, null, true, false, false, false, false);
--
-- INSERT INTO users (name, surname, email, password, address, phone, role, reported, blocked, deleted, favourite_accommodations, activation_link, activated, activation_expired, activation_timestamp, notification_enabled, request_notification_enabled, cancellation_notification_enabled, rating_notification_enabled, acc_notification_enabled)
-- VALUES ('Petar', 'Petrović', 'email2@gmail.com', '$2a$12$Mn1xmYaoG3YjZ1NsPRwV0eDw5wwGbmkhBSooynq8gldJluzqybXP.', 'adresa2', '060000001', 'OWNER', true, false, false, null, 'activation_link2', true, false, null, false, false, true, true, true);
--
-- INSERT INTO users (name, surname, email, password, address, phone, role, reported, blocked, deleted, favourite_accommodations, activation_link, activated, activation_expired, activation_timestamp, notification_enabled, request_notification_enabled, cancellation_notification_enabled, rating_notification_enabled, acc_notification_enabled)
-- VALUES ('Adam', 'Adamović', 'email3@gmail.com', '$2a$12$Mn1xmYaoG3YjZ1NsPRwV0eDw5wwGbmkhBSooynq8gldJluzqybXP.', 'adresa3', '060000002', 'GUEST', true, false, false, ARRAY[5, 6, 7, 8, 9], 'activation_link3', true, false, null, true, false, false, false, false);
--
-- INSERT INTO users (name, surname, email, password, address, phone, role, reported, blocked, deleted, favourite_accommodations, activation_link, activated, activation_expired, activation_timestamp, notification_enabled, request_notification_enabled, cancellation_notification_enabled, rating_notification_enabled, acc_notification_enabled)
...
--
-- INSERT INTO users (name, surname, email, password, address, phone, role, reported, blocked, deleted, favourite_accommodations, activation_link, activated, activation_expired, activation_timestamp)
-- VALUES ('Super', 'Admin', 'super123@gmail.com', '$2a$12$Mn1xmYaoG3YjZ1NsPRwV0eDw5wwGbmkhBSooynq8gldJluzqybXP.', 'Super adresa', '3210089', 'SUPER', false, false, false, null, 'activation_link6', true, false, null);
...
-- INSERT INTO accommodation (title, description, short_description, owner_id, deadline, min_capacity, max_capacity, type, accepted, manual_accepting)
-- VALUES ('Cozy Cottage', 'A cozy cottage in the countryside', 'Cozy cottage', 'owner123', 30, 2, 4, 0, true, false);



-- INSERT INTO accommodation (
--     id, title, description, short_description, owner_id, deadline, min_capacity, max_capacity, type, accepted, manual_accepting,
--     created_at_date, last_modified_date, created_by, last_modified_by
-- ) VALUES (
--              1, 'Cozy Cottage', 'A cozy cottage in the countryside', 'Cozy cottage', 'owner123', 30, 2, 4, 0, true, false,
--              '2024-05-29 10:00:00', '2024-05-29 10:00:00', 'admin', 'admin'
--          );

-- Inserting data into accommodation table
INSERT INTO accommodation
(title, description, short_description, owner_id, deadline, min_capacity, max_capacity, type, accepted, manual_accepting)
VALUES
    ('Luxury Villa', 'A luxurious villa with modern amenities.', 'Luxurious villa', 'owner123', 48, 2, 10, 0, true, false);

INSERT INTO accommodation
(title, description, short_description, owner_id, deadline, min_capacity, max_capacity, type, accepted, manual_accepting)
VALUES
    ('Cozy Cottage', 'A cozy cottage in the countryside.', 'Cozy countryside cottage', 'owner456', 24, 1, 4, 0, true, true);

INSERT INTO accommodation
(title, description, short_description, owner_id, deadline, min_capacity, max_capacity, type, accepted, manual_accepting)
VALUES
    ('Modern Apartment', 'A modern apartment in the city center.', 'City center apartment', 'owner789', 72, 1, 3, 0, false, false);
...
INSERT INTO Accommodation (title, description, short_description, deadline, min_capacity, max_capacity, owner_id, type, accepted, manual_accepting) VALUES ('Luxury Villa', 'A luxurious villa with stunning views.', 'Luxury villa with pool', 30, 1, 3, '1', 2, true, false);
...
INSERT INTO Availability (start_date, end_date, accommodation_id) VALUES ('2024-05-01', '2024-05-10', 1),('2024-06-15', '2024-06-28', 2), ('2024-07-20', '2024-08-05', 3);
...
INSERT INTO Reservation (guest_id, accommodation_id, from_date, to_date, number_of_guests, request_status, reservation_status, deleted, price, to_time)
VALUES
    ('7c32b61c-0123-44a1-aeed-4b5f2430a27a', 1, '2023-01-01', '2023-01-05', 1, 'ACCEPTED', 'ACCEPTED', false, 150.0, '2023-01-05 14:30:00'),
